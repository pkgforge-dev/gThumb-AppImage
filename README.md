...
[![GitHub Downloads](https://img.shields.io/github/downloads/pkgforge-dev/gThumb-AppImage/total?logo=github&label=GitHub%20Downloads)](https://github.com/pkgforge-dev/gThumb-AppImage/releases/latest)
[![CI Build Status](https://github.com/pkgforge-dev/gThumb-AppImage/actions/workflows/appimage.yml/badge.svg)](https://github.com/pkgforge-dev/gThumb-AppImage/releases/latest)
...
| :---: | :---: |
| [Click here](https://github.com/pkgforge-dev/gThumb-AppImage/releases/latest) | [Click here](https://gitlab.gnome.org/GNOME/gthumb) |
